...
![Fig. 1: Power Plants per County](outputs/map_plants_per_county.png){ width=80% }
...
![Fig. 2: Power plants within 50 km](outputs/map_nearby_plants.png){ width=80% }
...
![Fig. 3: Mean PM2.5 per county](outputs/map_pm25.png){ width=80% }
...
![Fig. 4: PM2.5 by plant presence](outputs/pm25_comparison.png){ width=80% }
